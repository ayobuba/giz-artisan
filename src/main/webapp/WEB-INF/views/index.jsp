                ...
                <div class="item carousel-item-eight active">
                    <div class="container">
                        <div class="carousel-position-six text-uppercase text-center">
                            <strong><h2 class="margin-bottom-20 animate-delay carousel-title-v5" data-animation="animated fadeInDown" style="color:blue;">
                                Welcome to Plateau <br/>
                                <span class="carousel-title-normal">State Artisan  Job Centre</span>
                            </h2></strong>
                            <p class="carousel-subtitle-v5 border-top-bottom margin-bottom-30" data-animation="animated fadeInDown" style="color:#eeeee;">This is what you were looking for</p>
                            <a class="carousel-btn-green" href="<spring:url value="/service/request"/>" data-animation="animated fadeInUp">Hire an Artisan!</a>
                        </div>
                    </div>
                </div>
          ...
          <div class="col-md-9">
            <div class="owl-carousel owl-carousel3">
              <div class="recent-work-item">
                <em>
                  <img src="<spring:url value="/resources/assets/pages/img/works/img1.jpg"/>" alt="Amazing Project" class="img-responsive">
