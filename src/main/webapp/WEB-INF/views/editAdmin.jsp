                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <spring:url value="/admin/edit" var="adminFormUrl"/>
                                    <form:form id="demo-form2" class="form-horizontal form-label-left" method="POST" action="${adminFormUrl}" modelAttribute="editObj">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <form:select  path="bioData.gender.genderId" id="gender" required="required" class="form-control col-md-7 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <form:textarea id="description" title="Describe your location" class="form-control col-md-7 col-xs-12" type="text" required="required" path="bioData.address.description"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                          		<form:select  path="bioData.address.lga.state.stateId" id="stateId" required="required" class="form-control col-md-7 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                          		<form:select path="bioData.address.lga.lgaId" id="lgaId" required="required" class="form-control col-md-7 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <form:input  id="userName" class="form-control col-md-7 col-xs-12" type="text" name="userName" required="required" path="bioData.username"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <form:input id="password" class="form-control col-md-7 col-xs-12" type="password"  required="required" path="bioData.password"/>
                                            </div>
                                        </div>
