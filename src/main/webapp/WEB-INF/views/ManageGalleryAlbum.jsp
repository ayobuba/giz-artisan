                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <br />
                                    <spring:url value="/album/create/gallery" var="albumUrlForm"/>
                                    <form:form id="demo-form2" class="form-horizontal form-label-left" method="POST" action="${albumUrlForm}" modelAttribute="pictureAlbum">

                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="albumTitle">Album Title <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <form:input type="text" id="albumTitle" required="required" class="form-control col-md-7 col-xs-12" path="albumTitle"/>
                                            </div>
                                        </div>
                                    ...
                                    <table id="example" class="table table-striped responsive-utilities jambo_table">
                                        ...
                                        <tbody>
                                            <c:forEach items="${albumList }" var="album">
                                                ...
                                                <td><a href="<spring:url value="/album/delete/${album.albumId }"/>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>Delete</a></td>
                                                <td ><a href="<spring:url value="/album/edit/${album.albumId }"/>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Update </a>
                                                </td>
                                                <td ><a href="<spring:url value="/gallery/add-gallery-image/${album.albumId}"/>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i> Add Pictures </a>
                                                </td>
                                            </tr>
                                            </c:forEach>
                                            <%sn=0; %>
