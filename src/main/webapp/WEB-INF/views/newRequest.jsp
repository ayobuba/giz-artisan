                                    ...
                                    <table id="example" class="table table-striped responsive-utilities jambo_table">
                                        <thead>
                                            <tr class="headings">
                                                ...
                                                <th>Client Name</th>
                                                <th>Rquested Date </th>
                                                <th class=" no-link last" colspan="4"><span class="nobr">Action</span>
                                                </th>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody>
                                            <tr class="even pointer">
                                                ...
                                                <td class=" last"><a href="#" class="">Pending</a></td>
                                                <td class=" last"><a href="#" class="">Approved</a></td>
                                                <td class=" last"><a href="#" class="">Disapproved</a></td>
                                                <td class=" last"><a href="#" class="">Update</a></td>
                                            </tr>
                                            

                                        </tbody>
                                    </table>
                                     <tr><td><button onClick="toggle(this)">Approved All</button></td></tr>
                                </div>
                            </div>
                        </div>
