                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <br />
                                    <spring:url value="/skill/add" var="skillUrlForm"/>
                                    <form:form id="demo-form2" class="form-horizontal form-label-left" method="POST" action="${skillUrlForm}" modelAttribute="skillcommand">
