...
<head>
    ...
    <title>GIZ! | Client Profile</title>
                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>{{Full Name of Client}} <small>Details</small></h2>
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                                        ...
                                        <h3>{{Full Name of Client}}</h3>

                                        <ul class="list-unstyled user_data">
                                            <li><i class="fa fa-map-marker user-profile-icon"></i> {{Address of Client}}
                                            </li>
