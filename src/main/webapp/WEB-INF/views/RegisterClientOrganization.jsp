...
<head>
  <meta charset="utf-8">
  <title>Artisan Job Centre | Client Registration (Organization)</title>
      ...
      <div class="container">
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="col-md-12 col-sm-12">
            <h3 id="form-heading">Register a New Client (Organization)</h3>
            <div class="content-form-page">
              <div class="row">
                <div class="col-md-10 col-sm-10">
                <h3>${msg}</h3>
                <spring:url value="/client/register/organization" var="orgFormUrl"/>
                  <form:form class="form-horizontal" role="form" method="POST" action="${orgFormUrl}" modelAttribute="orgCommand">
                    <fieldset>
                      <legend>Organization's details</legend>
                      <div class="form-group">
                        <label for="firstname" class="col-lg-4 control-label">Name of Organization <span class="require">*</span></label>
                        <div class="col-lg-8">
                          <form:input path="organizationName" type="text" class="form-control" id="firstname" name="oName"/>
                        </div>
                      </div>
                    ...
                    <fieldset>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-8">
                          <form:input path="phoneNumber.number" type="text" class="form-control" id="phoneNo" name="phoneNo"/>
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="email" class="col-lg-4 control-label">Email <span class="require">*</span></label>
                        <div class="col-lg-8">
                          <form:input path="email.emailAddress" type="email" class="form-control" id="email" name="email"/>
                        </div>
                      </div>
                        ...
                        <div class="col-lg-8">
                          <form:select  path="address.lga.state.stateId" id="title" required="require" class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-8">
                          <form:select  path="address.lga.lgaId" id="title" required="require" class="form-control col-md-7 col-xs-12">
                        ...
                        <div class="col-lg-8">
                          <form:textarea path="address.description" class="form-control" id="state" name="address" rows="5"/>
                        </div>
                      </div>
                    </fieldset>
                    <fieldset>
