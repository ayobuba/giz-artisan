                                    ...
                                    <h5><span style="color:green">${msg}</span><span style="color:red">${errMsg}</span></h5>
                                        ...
                                        <c:forEach items="${enrolledList}" var="enrolled">
                                            ...
                                            <tr class="even pointer">
                                            	<td class=" "><%=++sn %></td>
                                            	<td class=" ">${enrolled.artisan.subSkill.name}</td>
                                                <td class=" ">${enrolled.artisan.artisanBioData.lastName }</td>
                                                <td class=" ">${enrolled.artisan.artisanBioData.firstName }</td>
                                                <td class=" ">${enrolled.artisan.artisanBioData.gender.genderName }</td>
                                                <td class=" ">${enrolled.maritalStatus.status }</td>
                                                <td class=" ">${enrolled.yearsOfExperience}</td>
                                               
                                                
                                                
                                                 <td class=" last"><a href="<spring:url value="/enrol/invite/${enrolled.enrolmentId}"/>" class="btn btn-success btn-xs"><i class="fa fa-folder"></i>Invite</a>
                                                </td>
                                                <td class=" last"><a href="<spring:url value="/enrol/view/${enrolled.enrolmentId}"/>" class="btn btn-info btn-xs"><i class="fa fa-folder"></i>view Details</a>
                                                </td>
