...
<head>
    ...
    <title>GIZ! | Manage News Categories</title>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <br />
                                    <spring:url value="/newsType/manage" var="newsTypeUrlForm"/>
                                    <form:form id="demo-form2" class="form-horizontal form-label-left" method="POST" action="${newsTypeUrlForm}" modelAttribute="newsTypeCommand">

                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="skill-name">News Category <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <form:input type="text" id="newsType" required="required" class="form-control col-md-7 col-xs-12" path="newsType"/>
                                            </div>
                                        </div>
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <table id="example" class="table table-striped responsive-utilities jambo_table">
										...
										<%int sn=0; %>
                                        <tbody>
                                            <c:forEach items="${newsTypeList }" var="skill">
                                                <tr class="even pointer"> 
                                                    <td class="a-center ">
                                                    <input type="checkbox" class="tableflat">
                                                </td>
                                                <td class=" "><%=++sn %></td>
                                                <td class=" ">${skill.newsType}</td>
                                                </td>
                                            
                                                
                                                <td ><a href="<spring:url value=""/>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                                                </td>
                                                <td ><a href="<spring:url value="/newsType/addPost/${skill.newsTypeId }"/>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i> Add Post </a>
                                                </td>
                                                <td><a href="<spring:url value="/newsType/delete/${skill.newsTypeId }"/>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>Delete Category</a></td>
                                            </tr>
                                            </c:forEach>
                                            <% sn=0; %>
