                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <br />
                                    <spring:url value="/album/create/news" var="albumUrlForm"/>
                                    <form:form id="demo-form2" class="form-horizontal form-label-left" method="POST" action="${albumUrlForm}" modelAttribute="albumCommand">
                                    ...
                                    <table id="example" class="table table-striped responsive-utilities jambo_table">
                                        ...
                                        <tbody>
                                            <c:forEach items="${albumList }" var="album">
                                                ...
                                                <td ><a href="<spring:url value="/gallery/add-news-image/${album.albumId}"/>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i> Add Pictures </a>
                                                </td>
                                            </tr>
                                            </c:forEach>
                                            <%sn=0;%>
