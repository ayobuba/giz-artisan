                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <spring:url value="/artisan/register" var="adminFormUrl"/>
                                    <form:form id="demo-form2" enctype="multipart/form-data" class="form-horizontal form-label-left" method="POST" action="${adminFormUrl}" modelAttribute="artisanCommand">

                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="title">Title<span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                          <form:select path="artisanBioData.title.titleId" id="title" required="required" class="form-control col-md-7 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <form:input type="text" id="firstName"  required="required" class="form-control col-md-7 col-xs-12" path="artisanBioData.firstName"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <form:input type="text" id="lastName"  required="required" class="form-control col-md-7 col-xs-12" path="artisanBioData.lastName"/>
                                            </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <form:input type="email" id="email" required="required" class="form-control col-md-7 col-xs-12" path="artisanBioData.email.emailAddress"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <form:textarea  title="Describe your location" class="form-control col-md-7 col-xs-12" type="text" required="required" path="artisanBioData.address.description"/>
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                          		<form:select  path="artisanBioData.address.lga.state.stateId" id="title" required="required" class="form-control col-md-7 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                          		<form:select path="artisanBioData.address.lga.lgaId" id="title" required="required" class="form-control col-md-7 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="title">Select Skill<span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                          		<form:select path="subSkill.id" id="title" required="required" class="form-control col-md-7 col-xs-12">
                                            
                                           			 <c:forEach items="${subSkillList}" var="skill">
                                            			<form:option value="${skill.id }"><c:out value="${skill.name}"/></form:option>
                                            		</c:forEach>
